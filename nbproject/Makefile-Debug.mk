...
${OBJECTDIR}/gen.o: gen.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gen.o gen.c
...
${OBJECTDIR}/random_gauss.o: random_gauss.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/random_gauss.o random_gauss.c
...
${TESTDIR}/tests/newsimpletest.o: tests/newsimpletest.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I. -std=c99 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest.o tests/newsimpletest.c
...
${OBJECTDIR}/gen_nomain.o: ${OBJECTDIR}/gen.o gen.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gen_nomain.o gen.c;\
	else  \
...
${OBJECTDIR}/random_gauss_nomain.o: ${OBJECTDIR}/random_gauss.o random_gauss.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/random_gauss_nomain.o random_gauss.c;\
	else  \
